...
/** Céu estrelado determinístico (posições estáveis entre renders). Cores sutis:
 * maioria branca, algumas azuladas (quentes/frias) — como um céu real. */
...
// Estrelas brilhantes (com brilho + hastes), curadas nas bordas para não
// competir com o pódio central. size em px; cor do núcleo; atraso do cintilar.
const ASTROS = [
...
/** Fundo "espaço": nebulosas coloridas, campo de estrelas (com cor e brilho),
 * planetas, lua, um satélite lento e estrelas cadentes — tudo sutil e atrás do
 * conteúdo (o pódio central fica relativamente livre). */
function FundoConstela({ cor }: { cor: string }) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      />
      {/* Nebulosas: manchas coloridas bem suaves e borradas — profundidade cósmica. */}
      ...
      {/* Campo de estrelas pequenas (com cor sutil). */}
      ...
      {/* Estrelas brilhantes com brilho + hastes (também cintilam). */}
      {ASTROS.map((a, i) => (
      ...
      {/* Planeta grande espreitando do canto inferior-esquerdo. */}
      ...
      {/* Satélite cruzando o céu bem devagar. */}
      ...
      {/* Estrelas cadentes — a 1ª logo no início; ciclos variados. */}
